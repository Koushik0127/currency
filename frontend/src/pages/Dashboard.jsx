...
//             <input className="input" placeholder="Enter deposit amount" value={depositAmt} onChange={e => setDepositAmt(e.target.value)} />
//             <button className="btn btn-primary" onClick={handleDeposit}>Deposit</button>
//           </div>
//           <div className="form-row">
//             <input className="input" placeholder="Enter withdraw amount" value={withdrawAmt} onChange={e => setWithdrawAmt(e.target.value)} />
...
//               <thead>
//                 <tr>
//                   <th>Type</th><th>Amount</th><th>Currency</th><th>Converted</th><th>To</th><th>Time</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {transactions.map((tx) => (
